...
with mlflow.start_run():
    ...
    # Simpan model secara langsung jika tidak menggunakan server
    mlflow.sklearn.save_model(best_model, "best_logistic_regression_model")
